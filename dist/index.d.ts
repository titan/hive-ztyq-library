...
export declare function getAccuratePrice(thpBizID: string, licenseNo: string, cityCode: string, responseNo: string, biBeginDate: string, ciBeginDate: string, carInfo: Car, personInfo: Person, channelCode: string, insurerCode: string, coverageList: Coverage[], options?: Option): Promise<any>;
